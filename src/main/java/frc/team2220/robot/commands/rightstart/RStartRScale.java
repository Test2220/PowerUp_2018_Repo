...
//        addSequential(new StopShooter());
          addSequential(new PathReader("/home/lvuser/paths/LeftStart/RStartRScale_right_detailed.csv", "/home/lvuser/paths/LeftStart/RStartRScale_right_detailed.csv", 0.007));
          addParallel(new ShootScale());
          addParallel(new Shoot());
          addSequential(new Shoot());
          addParallel(new StopShooter());
          addSequential(new RelativeTurnToAngle(145));
    }
