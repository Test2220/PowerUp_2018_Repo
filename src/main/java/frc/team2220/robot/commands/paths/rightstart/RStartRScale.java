...
//        addSequential(new StopShooter());
        ...
        addParallel(new PreAutoDefault(PreAutoDefault.FinalShooterPosition.SCALE));
        addSequential(new MultiReversiblePathReader("RightStart/RScale_Init", 20, MultiReversiblePathReader.Direction.SHOOTER_FIRST, MultiReversiblePathReader.CSVReadDirection.TOP_TO_BOTTOM));
        addSequential(new RelativeTurnToAngle(-70, 1.8));
        addSequential(new AutoScale(0.7, 2));
        addSequential(new StopShooter());
